            ...
            <div>
                ...
                <div className="footer-contentSection-3">
                    ...
                    <div className="footer-contact-us-content-container">
                        ...
                        <div className="footer-content">sales@delightcapitals.com, info@delightcapitals.com</div>
                    </div>
                    <div className="footer-contact-us-content-container">
                    ...
                    <div className="footer-delight-online">EXPERIENCE DCS APP ON MOBILE</div>
                ...
                <div className="footer-devider"></div>
                 <div className="footer-bottom">Copyright © 2021 Delight Capital Solutions - All Rights Reserved.</div>
            </div>
        </div>
    </div>
</div>;
